...
export class JoinUs extends Component {
  ...
  handleRequest() {
    ...
    const request = $.ajax({
      url: 'http://fltasite.com/mail.php',
      type: 'post',
      data: req,
    });
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offet-12 header">
              <p className="title"
                 dangerouslySetInnerHTML={{ __html: 'Join Fort Lauderdale\'s Tech community' }} />
              <p className="info"
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
              { !succes
                ...
                : <span className="succes">
                    <p className="title">
                      Thanks, and welcome to the Fort Lauderdale Tech community!
                    </p>
                    <p className="text">
